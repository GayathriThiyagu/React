  ...
  return (
    <>
       <header className="header">
        <div className="logo">T. GAYATHRI</div>
    ...
    <section className="hero">
        <div className="hero-content">
            <h1>HI<span>,</span> I AM <br/> GAYATHRI <span>.</span></h1>
    ...
    <section className="about-section">
        ...
        <div className="about-content">
            <div className="about-text">
                <p>
                    I am Gayathri, Currently studying in Saveetha Engineering college. 
                    I am excelled in C, Python, Problem solving, Machine Learning, Frontend development.
                </p>
                <p>
                ...
                <div className="contact-info">
                    ...
                    <div className="contact-item">
                        <h4>Email</h4>
                        <p>gayu.thiyagu1908@gmail.com</p>
                    </div>
                    <div className="contact-item">
                        <h4>Website</h4>
                        <p>www.gayathrithiyagu.com</p>
                    </div>
                </div>
            </div>
            <div className="about-image">
                <img src="images/photo.jpg" alt="Gayathri" width="220px"/>
                <div className="social-links">
                    <a href="https://github.com/GayathriThiyagu" target="_blank">🔗 GitHub</a>
                    <a href="https://www.linkedin.com/in/gayathri-thiyagu-035b30290" target="_blank">🔗 LinkedIn</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div className="contact-section-content">
            ...
            <div className="contact-details">
                ...
                <div className="socials">
                    <img src="images/instagram logo.jpg" width="65px" alt="instagram-logo"/>
                    <img src="images/wa logo.jpeg" width="45px" alt="whatsapp-logo"/>
                    <img src="images/twitterx logo.jpeg" width="30px" alt="x-logo"/>
                    <img src="images/pinterest logo.jpeg" width="50px" alt="pinterest-logo"/>
                </div>
            </div>
        </div>
    </section>
